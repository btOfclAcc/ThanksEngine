...
void GameState::Initialize()
{
	...
	for (int i = 0; i < 1; i++)
	{
		...
		planet.diffuseMapId = TextureCache::Get()->LoadTexture("avatar/ao3icon.jpg");
		planet.normalMapId = TextureCache::Get()->LoadTexture("avatar/ao3icon_NormalMap.png");
		planet.specMapId = TextureCache::Get()->LoadTexture("avatar/ao3icon_Specular.png");
		planet.bumpMapId = TextureCache::Get()->LoadTexture("avatar/ao3icon_NormalMap.png");
