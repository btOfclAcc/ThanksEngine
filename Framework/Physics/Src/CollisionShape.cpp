...
void CollisionShape::InitializeBox(const ThanksEngine::Math::Vector3& halfExtents)
{
	ASSERT(mCollisionShape == nullptr, "CollisionShape: Shape is already initialized");
	mCollisionShape = new btBoxShape(TobtVector3(halfExtents));
}

void CollisionShape::InitializeHull(const ThanksEngine::Math::Vector3& halfExtents, const ThanksEngine::Math::Vector3& origin)
{
	ASSERT(mCollisionShape == nullptr, "CollisionShape: Shape is already initialized");
	btConvexHullShape* hullShape = new btConvexHullShape();
	std::vector<ThanksEngine::Math::Vector3> points =
	{
	...
	for (ThanksEngine::Math::Vector3& point : points)
	{
